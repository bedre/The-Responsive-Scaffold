...
/* CONFIG ----------------------------------------------------------------------------------------------------------- */
$resolutions   = array(2200, 1900, 1620, 1440, 1024, 720, 480, 320); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "skagen-hotell/public_html/images/ai-cache"; // where to store the generated re-sized images. Specify from your document root!
...
if ($debug) {
  echo "Docroot : ".$document_root."<br>";
  echo "Req uri : ".$requested_uri."<br>";
  echo "Req file : ".$requested_file."<br>";
  echo "SOurce file : ".$source_file."<br>";
  echo "Cache to: $document_root/$cache_path<br>";
}
...
function generateImage($source_file, $cache_file, $resolution) {
  ...
  global $sharpen, $jpg_quality, $debug;
  ...
  if ($debug) {
    echo "Generate image from $source_file <br>";
    echo "A $extension image is going to be resized to $new_width x $new_height <br>";
  }
